...
{
    public partial class OutData_Window : Form
    {
        public static OutData_Window outData_;

        public OutData_Window()
        {
            InitializeComponent();
        ...
        static void TaskMethod(object title)
        {
            lock (taskMethodLocj)
            {
                DataGridView dataGridView1 = OutData_Window.outData_.dataGridView1;
